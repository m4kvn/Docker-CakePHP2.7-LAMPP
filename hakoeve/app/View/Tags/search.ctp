...
$tags="";
 foreach ($searchtag as $tag1):
 $tags.=$tag1[Tag][tag_name] . "　";
 endforeach;
 echo $tags;?>
 </font>
 <font size='3' color="#000000"> で検索しています
 </font>
<?php } ?>
   	</font></h2>
...
<div id="ps_box">
   <TABLE style="padding:0; float: right;margin-top: 5px;">
    <tr style="padding:0;">
     <?php if($id > 1){?>
     <td class="pages"><a class="page" href="<?php echo $this->Html->url(array("?" => array("id" => $id -1, "tagid" => $tagId)));?>">＜前へ</a></td>
     <?php
	}else{?>
	...
	if($id != $i){
 ?>     <td class="pages"><a class="page" href="<?php echo $this->Html->url(array("?" => array("id" => $i, "tagid" => $tagId)));?>"><?php echo $i;?></a></td>
 <?php }else{  ?>
 ...
 <?php  }
     ...
     <?php if($id < ceil($eventNum / 20)){ ?>
      <td class="pages" style="padding-right:0;"><a class="page" href="<?php echo $this->Html->url(array("?" => array("id" => $id + 1, "tagid" => $tagId)));?>">次へ＞</a></td>
     <?php
...
<?php } else { ?>
	<br><br>
	<font size='3'> 
	<?php echo $tags ?>に一致するイベントは見つかりませんでした。
...
<?php }?>
  ...
  <!--イベント一覧を表示-->
  <?php $ImageNum = 0;?>
 <?php if($result != 1) foreach ($result as $value): ?>
<div class="image">
...
<div class='new'>
  ...
  <font color='#00bfff' size='5'><a href="/hakoeve/events/view/<?php echo $value['Event']['id'];?>">
    ...
    <?php  if ( mb_strlen( $value['Event']['event_name'] ) > 40 ) {
...
<div style="float: left; height: 15px; margin-top: 10px;">
&nbsp;全<?php echo $allresult;?>件中&nbsp;&nbsp;<?php echo count($result);?>件表示</div>
<div class="page_select_area" style="width: 400px;float: right;margin-top: 10px;">
<div id="ps_box">

   <TABLE style="padding:0; float:right; margin-top: 0px;">
    <tr style="padding:0;">
     <?php if($id > 1){?>
     <td class="pages"><a class="page" href="/hakoeve/tags/search<?php echo $this->Html->url(array("?" => array("id" => $id -1, "tagid" => $tagId)));?>">＜前へ</a></td>
     <?php
  }else{?>
     <td class="pages"><a class="page" style=" background-color: #9fa0a0; color:#fff;">＜前へ</a></td>
     <?php } ?>
    ...
    for($i = 1; $i <= ceil($eventNum / 20/*表示件数*/); $i++){
  if($id != $i){
 ?>     <td class="pages"><a class="page" href="/hakoeve/tags/search<?php echo $this->Html->url(array("?" => array("id" => $i, "tagid" => $tagId)));?>"><?php echo $i;?></a></td>
 <?php }else{  ?>
    <td class="pages"><a class="page" style="background-color:#9fa0a0; color:#fff;"><?php echo $i;?></a></td>
 <?php  }
  }
 ...
 <?php  }
      ...
      ?>
     <?php if($id < ceil($eventNum / 20)){ ?>
      <td class="pages" style="padding-right:0;"><a class="page" href="/hakoeve/tags/search<?php echo $this->Html->url(array("?" => array("id" => $id + 1, "tagid" => $tagId)));?>">次へ＞</a></td>
     <?php
     $tagsearch = $_POST["tagsearch"];
      }else{ ?>
      <td class="pages" style="padding-right:0;"><a class="page" style="background-color: #9fa0a0; color:#fff;">次へ＞</a></td>
