...
//  /_/_/_/_/_/_/_/ 基本設定 /_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
     ...
     *  過去未来のカレンダ描画機能を使用しない
     */
    clndrVar.fixed          = false; // �͂� -> true | ������ -> false
...
//  /_/_/_/_/_/_/_/ 属性等の設定 /_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
     ...
     */
    clndrAttrs.week     = "class='X_calendar_weeks'" ; //これ
    clndrAttrs.week2     = "class='X_calendar_weeks2'" ; //これ
    clndrAttrs.week3     = "class='X_calendar_weeks3'" ; //これ
...
function calmonthlink(_y, _m)
{

    var capStr  = clndrVar.monthlink;
    capStr      = calendar_isReplace(capStr, "%Y", _y);
    var tmpY    = _y % 10;
    capStr      = calendar_isReplace(capStr, "%y", tmpY<10? "0"+tmpY: tmpY);
    capStr      = calendar_isReplace(capStr, "%M", _m);
...
if(_m==10||_m==11||_m==12){
	return "<a href='/hakoeve/eventdates/searchmonth/"+_y+_m+'01'+"'>"+ capStr+'のイベント一覧'+"<\a>";
  }else{
    return "<a href='/hakoeve/eventdates/searchmonth/"+_y+'0'+_m+'01'+"'>"+ capStr+'のイベント一覧'+"<\a>";
}
}
...
function calendar_make(_y, _m)
{
    ...
    var tmp     = "";
    var monthlink = calmonthlink(d.year, d.month);
    ...
    for (var i=1; i<6; i++)
        weeks   += "<th "+ clndrAttrs.week2+ ">"
                +   (clndrAttrs.weekF? "<font "+ clndrAttrs.weekF+ ">"+ w[i]+ "<\x2ffont>": w[i])
                +   "<\x2fth>";
    
    
    for (var i=6; i<7; i++)
        weeks   += "<th "+ clndrAttrs.week3+ ">"
                +   (clndrAttrs.weekF? "<font "+ clndrAttrs.weekF+ ">"+ w[i]+ "<\x2ffont>": w[i])
                +   "<\x2fth>";
    ...
    return      "<table "+ clndrAttrs.table+ ">"
            ...
            +   "<\x2ftbody><\x2ftable>"
            +  "<caption "+ clndrAttrs.caption+ ">"+ monthlink+ "<\x2fcaption>"
            ;
}
