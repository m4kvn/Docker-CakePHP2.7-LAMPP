...
(function (document, window, $document, $window, $body, $) {
  ...
  var GI_TW_ID = 0,
    TheWall = function ($el, myOptions) {
       ...
       */
      this.$el = $el;
      this.$expanderWrapper = $('<div class="GI_TW_expander" id="poster_view"></div>');
      this.$contentPointer = $('<div class="GI_TW_pointer"></div>');
      this.$expanderInner = $('<div class="GI_TW_expander-inner" id="inner"></div>');
      ...
      this.next = function () {
        ...
        var Element = document.getElementById(this.currentIndex+1);
        console.log(Element);
        var display_value = document.defaultView.getComputedStyle(Element, null).getPropertyValue("display");
        console.log(display_value);
        if (display_value == "none") return;
